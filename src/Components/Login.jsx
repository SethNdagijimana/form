...
function Login() {
  return (
    ...
    <div class="sign--head">
        ...
        <p class="signup-message">New to GoDaddy? <a href="htppgoogle.com">Create an Account</a></p>
    ...
    <div class="form-footer">
        ...
        <p class="form-footer--description">Need to find <a href="google.com">your username</a> or <a href="google.com"> your password</a>?</p>
    </div>
</section>
